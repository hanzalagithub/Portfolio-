...
const socials = [ 
 { 
   icon: faEnvelope, 
   url: 'https://www.ahmedhanzala2020@gmail.com', 
 }, 
 { 
   icon: faGithub, 
 ...
 { 
   icon: faLinkedin, 
   url: 'https://linkedin.com/in/ahmed-hanzala-4324a326b', 
 }, 
 { 
   icon: faFacebook, 
   url: 'https://www.facebook.com/ahmed.hanzala.35?mibextid=ZbWKwL', 
 }, 
 { 
   icon: faInstagram, 
   url: 'https://instagram.com/freez_the_sec?igshid=MzRlODBiNWFlZA==', 
 }, 
]; 
